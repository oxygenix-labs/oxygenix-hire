...
export function Step4HiringDecision({ jobId, initialData, onComplete }: Step4Props) {
    ...
    const [scorecard, setScorecard] = useState(initialData?.scorecard || "1. Technical Skills (1-5)\n2. Culture Fit (1-5)\n3. Communication (1-5)")
    ...
    return (
        <div className="space-y-6">
            <div>
                ...
                <p className="text-muted-foreground">Define the scorecard criteria for making the final decision.</p>
            </div>
