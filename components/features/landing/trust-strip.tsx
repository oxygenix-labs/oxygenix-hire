        ...
        <section className="py-10 border-y bg-muted/30">
            <div className="container text-center">
                ...
                <div className="mt-8 grid grid-cols-2 gap-8 md:grid-cols-4 lg:grid-cols-5 opacity-70 grayscale transition-all hover:grayscale-0 hover:opacity-100">
                    ...
                    <div className="flex items-center justify-center text-xl font-bold font-heading text-foreground/80">
                        Acme Corp
                    </div>
                    <div className="flex items-center justify-center text-xl font-bold font-heading text-foreground/80">
                        Global Tech
                    ...
                    <div className="flex items-center justify-center text-xl font-bold font-heading text-foreground/80 hidden lg:flex">
                        Umbrella
                    </div>
                </div>
            </div>
